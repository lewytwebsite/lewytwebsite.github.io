        ...
        <div class = "col-lg-10 col-lg-offset-1">
          <div class = "col-lg-4 leaders">
            ...
            <div class="collapse" id="trustee1">
                <p> Wendy McColgan is one of the two trustees of the Alex & Elisabeth Lewyt
            ...
            <span> <b>Thomas Amlicke</b> </span> <span class = "title"> CO-TRUSTEE </span>
            <span style = "float:right" class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
            </a>
            <div class="collapse" id="trustee2">
                <p> Thomas Amlicke, who was a counsel and friend to Mrs. Lewyt for over 20 years, is the other co-trustee of the Alex & Elisabeth Lewyt Charitable Trust. A seasoned trusts and estates attorney with more than 50 years of experience, Tom   received the Accredited Estate Planner® (AEP®) designation by the National Association of Estate Planners and Councils in 2004, and has been selected as a New York Super Lawyer in the New York metropolitan area every year since 2008.  Well-versed in the area of trust administration, Tom holds a B.A from Dartmouth and an LL.B. from Columbia University.He is the proud owner of his beloved [insert name here], a former shelter dog whom he adopted several years ago.</p>
            </div>
            <hr>
          ...
          <div class = "col-lg-8">
            ...
            <h3><i> Alex & Elisabeth Lewyt Charitable Trust </i> </h3>
            <hr>
            <p class = "opening"> After her passing in 2012, Mrs. Lewyt left the bulk of her and her husband’s fortune to the newly created Alex & Elisabeth Lewyt Charitable Trust, to carry on their philanthropy 
